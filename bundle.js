...
},{"./History":7,"./Location":9,"react":undefined}],13:[function(require,module,exports){
'use strict';
...
},{"./PropTypes":12,"./RouteUtils":15,"./URLUtils":23,"invariant":25,"react":undefined}],14:[function(require,module,exports){
'use strict';
...
},{"./PropTypes":12,"./RouteUtils":15,"invariant":25,"react":undefined,"warning":32}],15:[function(require,module,exports){
'use strict';
...
},{"react":undefined,"warning":32}],16:[function(require,module,exports){
'use strict';
...
module.exports = exports['default'];
},{"./AsyncUtils":5,"./Location":9,"./PropTypes":12,"./RouteUtils":15,"./RouterContextMixin":17,"./RoutingUtils":18,"./ScrollManagementMixin":19,"./Transition":21,"invariant":25,"react":undefined,"warning":32}],17:[function(require,module,exports){
'use strict';
...
module.exports = exports['default'];
},{"./URLUtils":23,"invariant":25,"react":undefined}],18:[function(require,module,exports){
'use strict';
...
},{"./AsyncUtils":5,"./RouteUtils":15,"./URLUtils":23,"invariant":25}],19:[function(require,module,exports){
'use strict';
...
module.exports = exports['default'];
},{"./DOMUtils":6,"./NavigationTypes":11,"react":undefined}],20:[function(require,module,exports){
'use strict';
...
module.exports = exports['default'];
},{"react":undefined,"warning":32}],23:[function(require,module,exports){
'use strict';
...
},{"classnames":undefined,"material-design-lite":3,"react":undefined}],35:[function(require,module,exports){
'use strict';
...
},{"classnames":undefined,"lodash":2,"material-design-lite":3,"react":undefined}],36:[function(require,module,exports){
'use strict';
                ...
                _react2['default'].createElement(
                    ...
                    _react2['default'].createElement(
                        ...
                        this.props.links.map(function (link, idx) {
                            var k = {};
                            if (link.badge) {
                                k = _react2['default'].createElement('span', { className: 'mdl-badge', 'data-badge': link.badge });
                            }
                            return _react2['default'].createElement(
                                'li',
                                { key: idx, className: 'DrawerView--NavLink mdl-typography--subhead' },
                                _react2['default'].createElement(
                                    _reactRouter.Link,
                                    { className: 'Link--Native', to: link.path },
                                    link.name
                                ),
                                k
                            );
...
},{"classnames":undefined,"react":undefined,"react-router":24}],37:[function(require,module,exports){
'use strict';
...
var Layout = (function (_React$Component) {
	...
	_createClass(Layout, [{
		...
		value: function render() {
			...
			var props = _objectWithoutProperties(_props, ['alignItems', 'justifyContent']);

			alignItems = 'mdl-align-items-' + alignItems;
			justifyContent = 'mdl-justify-content-' + justifyContent;

			var cname = (0, _classnames2['default'])({ 'Vertical-Layout': this.props.vertical }, { 'Horizontal-Layout': this.props.horizontal }, justifyContent, alignItems);
...
},{"classnames":undefined,"material-design-lite":3,"react":undefined}],39:[function(require,module,exports){
'use strict';
...
},{"./lib/Ring":43,"./lib/SmartScroll":44,"es6-promise":1,"react":undefined}],40:[function(require,module,exports){
'use strict';
...
var MDLSwiperTabsView = (function (_React$Component) {
	function MDLSwiperTabsView(props) {
		_classCallCheck(this, MDLSwiperTabsView);

		_get(Object.getPrototypeOf(MDLSwiperTabsView.prototype), 'constructor', this).call(this, props);
	...
	_inherits(MDLSwiperTabsView, _React$Component);

	_createClass(MDLSwiperTabsView, [{
		key: 'componentDidMount',
		value: function componentDidMount() {
			var _this = this;

			var element = _react2['default'].findDOMNode(this.refs.swipeContainer);
		...
		value: function render() {
			...
			return _react2['default'].createElement(
				...
				_react2['default'].createElement(
					'div',
					{ ref: 'swipeContainer', className: 'swiper-container' },
					_react2['default'].createElement(
						'div',
						{ className: 'swiper-wrapper flex-fill-fix' },
						_react2['default'].Children.map(this.props.children, function (element, index) {
							return _react2['default'].createElement(
								'div',
	...
	return MDLSwiperTabsView;
})(_react2['default'].Component);

var UITabsView = (function (_React$Component2) {
	/*  
 ...
 */
	...
	_inherits(UITabsView, _React$Component2);

	_createClass(UITabsView, [{
		key: 'componentDidMount',
		value: function componentDidMount() {
			var scrollerNode = _react2['default'].findDOMNode(this.refs.foo);
			this._scroller = new _libSmartScrollJs2['default'](scrollerNode, {
				eventPerSecond: 10,
				// snapEvents: true,
				raf: false
			});
		...
		value: function _handleScrollEnd(e) {
			console.log(e);
			var scrollerNode = _react2['default'].findDOMNode(this.refs.foo);
			var viewPortWidth = scrollerNode.offsetWidth;
			var scrollX = e.scrollLeft + viewPortWidth / 2;
			var index = Math.floor(scrollX / viewPortWidth);
		...
		key: 'openTab',
		value: function openTab(index) {
			var scroller = _react2['default'].findDOMNode(this.refs.foo);
			...
			return _react2['default'].createElement(
				...
				_react2['default'].createElement(
						...
						_react2['default'].createElement(
							...
							_react2['default'].Children.map(this.props.children, function (element, index) {
								var className = (0, _classnames2['default'])('TabView--TabHeader', {
									'TabView--TabHeader-active': index === _this3.state.selectedTab
								});
								return _react2['default'].createElement(
									'li',
									{ onClick: function (e) {
											return _this3.openTab(index);
										}, className: className },
									element.props.title
								);
							})
					...
					_react2['default'].createElement(
						...
						_react2['default'].createElement(
							'div',
							{ className: 'TabView--ScrollContainer', ref: 'foo', style: containerStyle },
							_react2['default'].Children.map(this.props.children, function (element, index) {
								return _react2['default'].createElement(
									'div',
									{ key: index, className: 'TabView--TabWrapper', style: { left: '' + 100 * (index - _this3.state.selectedTab) + '%' } },
									element
								);
							})
						)
...
},{"./UILayout.js":37,"./lib/Ring.js":43,"./lib/SmartScroll.js":44,"classnames":undefined,"material-design-lite":3,"react":undefined,"swiper":33}],41:[function(require,module,exports){
'use strict';
...
var Textfield = (function (_React$Component) {
	...
	_createClass(Textfield, [{
		...
		value: function render() {
			...
			var props = _objectWithoutProperties(_props, ['floating', 'expandable', 'key', 'multiline', 'className']);

			var cname = (0, _classnames2['default'])('mdl-textfield', 'mdl-js-textfield', {
			...
			return _react2['default'].createElement(
				'div',
				{ className: cname },
				_react2['default'].createElement('input', _extends({ className: 'mdl-textfield__input', type: 'text', id: id }, props)),
				_react2['default'].createElement(
					'label',
...
},{"classnames":undefined,"lodash":2,"material-design-lite":3,"react":undefined}],42:[function(require,module,exports){
"use strict";
...
var SmartScroll = (function (_EventEmitter) {
	...
	_createClass(SmartScroll, [{
		...
		value: function _handleTouchEnd(e) {
			...
			if (this._snapEvents) {
				...
				setTimeout(function (t) {
					_this._element.style.overflowX = 'auto';
					_this._element.scrollLeft = _this._lastLeft;
					_this._sendStopped();
				}, 40);
			}
		}
		...
		value: function _handleNativeTimeout(e) {
			...
			setTimeout(function (t) {
				return _this4._throttledScroll(e);
			}, this._throttleBy);
		}
	}]);
...
},{"./EventEmitter":42}],"react-ui-components":[function(require,module,exports){
'use strict';
...
},{"./UIButtonView":34,"./UICard":35,"./UIDrawerView":36,"./UILayout.js":37,"./UILoader":38,"./UIScrollView":39,"./UITabsView.js":40,"./UITextField":41}]},{},[]);
